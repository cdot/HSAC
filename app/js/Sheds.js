...
define([
  ...
  class Sheds {
    ...
    /**
     * @param params parsed from the URL in main.js
     * @param params.debug - enable debugging
     * @param params.cache_url - override the cache url (normally read
     * from cookies)
     * @param params.console - redirect debugging output to a console.
